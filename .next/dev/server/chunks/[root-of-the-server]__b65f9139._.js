...
async function POST(request) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const { name, email, password, business_name, plan = 'free' } = await request.json();
        // Validation
        if (!name || !email || !password || !business_name) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Missing required fields', 400);
        }
        if (password.length < 6) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Password must be at least 6 characters', 400);
        }
        ...
        if (existingUser) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Email already registered', 409);
        }
        // Create user
        ...
        // Generate token
        const access_token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateToken"])(user);
        const userResponse = {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["successResponse"])('User registered successfully', {
            user: userResponse,
            auth: {
                access_token,
                token_type: 'bearer',
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$utils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["errorResponse"])('Internal server error', 500);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__b65f9139._.js.map