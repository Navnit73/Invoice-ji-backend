...
// Validate ../../../app/api/auth/upgrade/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/auth/upgrade">> = Specific
  const handler = {} as typeof import("../../../app/api/auth/upgrade/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
